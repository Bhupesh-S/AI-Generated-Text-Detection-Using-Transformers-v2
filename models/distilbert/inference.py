...
inference.py
============
Inference module for the fine-tuned DistilBERT model.

Usage (CLI):
    python models/distilbert/inference.py --text "Your academic text here"
    python models/distilbert/inference.py --file path/to/texts.txt
    python models/distilbert/inference.py --interactive

Programmatic usage:
    from models.distilbert.inference import DistilBERTInference
    predictor = DistilBERTInference()
...
# Allow ``python models/distilbert/inference.py`` to find sibling modules
...
class DistilBERTInference:
    """
    High-level inference wrapper for the fine-tuned DistilBERT classifier.
    ...
    def __init__(
        ...
        Args:
            model_dir : Directory containing the saved model and tokenizer.
                        Defaults to ``outputs/distilbert/tokenizer``.
        ...
        if not self.model_dir.exists():
            raise FileNotFoundError(
                ...
                "Run 'python models/distilbert/train.py' first to train and save the model."
            )
    ...
    def predict(self, text: str) -> Dict:
        ...
        Returns:
            Dictionary with prediction properties.
        """
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run inference with the fine-tuned DistilBERT model."
    )
...
def main() -> None:
    ...
    # Load model once
    predictor = DistilBERTInference(model_dir=args.model_dir)
    ...
    if args.text:
        ...
        # Interactive REPL
        print("\nDistilBERT AI-Generated Text Detector (type 'quit' to exit)\n")
        while True:
            try:
