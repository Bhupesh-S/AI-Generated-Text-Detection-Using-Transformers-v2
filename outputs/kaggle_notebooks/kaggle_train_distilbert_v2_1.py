"""
================================================================================
Kaggle Notebook: DistilBERT V2.1 Fine-Tuning (T4 x2 Dual-GPU FP16 Optimized)
================================================================================
...
use_fp16 = torch.cuda.is_available() and not is_bf16_ok # Standard FP16 is 100% safe for DistilBERT
...
# ==============================================================================
print("\nStarting DistilBERT Fine-Tuning on Kaggle Environment...\n")
...
# Save Metrics JSON
metrics_filepath = METRICS_DIR / "distilbert_v2_1_metrics.json"
