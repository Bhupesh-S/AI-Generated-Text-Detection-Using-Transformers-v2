"""
================================================================================
Kaggle Notebook Script: DeBERTa-v3 V2.1 Multi-GPU PyTorch DDP Fine-Tuning
================================================================================
Launch via Kaggle cell:
  !torchrun --nproc_per_node=2 train_deberta_kaggle.py

Target Accelerator: Kaggle NVIDIA T4 x2 (Dual GPU DistributedDataParallel)
...
def main():
    ...
    if is_rank_zero:
        print("=" * 65)
        print("  DEBERTA-V3 MULTI-GPU DDP FINE-TUNING")
        print("=" * 65)
    ...
    training_args_kwargs = {
        ...
        "logging_steps": 100,
        "fp16": False, # FP32 required for DeBERTa-v3 on T4
        "bf16": False,
    ...
    print(f"\n[Process Rank {local_rank}] Starting DeBERTa Training...\n", flush=True)
    ...
    if is_rank_zero:
        ...
        print(f"\n[COMPLETE] DeBERTa-v3 Multi-GPU Training Finished! Saved under {BASE_OUT_DIR}")
